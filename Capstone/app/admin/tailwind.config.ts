...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        ph: {
          navy: { DEFAULT: "#0C1F3E", light: "#162D58", pale: "#EEF1F7" },
          gold: { DEFAULT: "#C8911E", light: "#F5D99A", pale: "#FEF8EC" },
          red: { DEFAULT: "#B8192D", pale: "#FDEAEA" },
          ocean: { DEFAULT: "#0D5C6E", pale: "#EAF4F6" },
        },
      },
